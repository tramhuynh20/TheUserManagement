            ...
            <div id="page-content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <table class="table table-data2">
                        ...
                        <tbody>
                        <form action="UpdatePromotionController" method="post">
                            <button type="submit" class="btn">Update</i></button>
                            <c:forEach items="${requestScope.listUser}" var="user">
                                ...
                                <tr class="tr-shadow">
                                    ...
                                    <td>                                       
                                        <input type="number" id="rank" name="rank" min="1" max="10" value="${user.rank}">
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <button type="button" onclick="location.href = 'UpdateDeletePromotionController?userID=${user.userID}'" class="btn"><i class="fa fa-trash"></i></button>
                                    </td>
                                </tr>
                                <tr class="spacer"></tr>
                            </c:forEach>
