...
public class InsertUserController extends HttpServlet {
    ...
    private static final String INSERT_USER = "insertUser.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (dao.getUserByID(userID) != null) {
                check = false;
                error.setUserID("User ID was existed!!!");
            }
            ...
            if (check == false) {
                ...
                User user = new User(userID, userName, email, phoneNumber, imageURL, toHexString(getSHA(password)), createDate, rank, status, statusPromotion, roleID);
